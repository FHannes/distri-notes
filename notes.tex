...
\textbf{XML} is a markup language defined by the WWW consortium. It tags data items with markup string, which contain metadata. The naming of these tags is chosen by the user, but generally gives some indication regarding the meaning of the value it accompanies.
